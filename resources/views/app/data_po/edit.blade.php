        ...
        <div class="card-body pt-0">
          ...
          <div class="row">
            ...
            <div class="col-lg-5">
              ...
              <form method="POST" action="{{ route('user.update', ['id' => $user->id_po]) }}" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                ...
                <div class="form-group">
                  <div class="form-group has-feedback">
                    ...
                    <select class="form-control @error('level') is-invalid @enderror" name="level">
                        @i
                        <option value=""></option>
                      <option <?php if(old("level", $user->level) == "admin"){echo "selected='selected'";} ?> value="">Admin</option>
