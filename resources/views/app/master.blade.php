...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header bg-white text-center">
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    <b class="logo-abbr"><img src="{{ asset('gambar/sistem/logo-pt.png')}}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('gambar/sistem/logo-pt.png') }}" alt=""></span>
                    <span class="brand-title">
                        <img src="{{ asset('gambar/sistem/logo-pt.png')}}" alt="" style="height: 30px"> 
                        <span class="text-white ml-2">Finance</span>
                    </span>
                </a>
            </div>
        </div>
            ...
            <div class="media align-items-center mb-1 mt-3">
               ...
               @endif
                <div class="media-body">
                    ...
                    <p class="text-muted mb-0"><?php if(Auth::user()->level == "manajer"){ echo "Manajer";}else{ echo "Finance"; } ?></p>
                </div>
            </div>
        </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li class="mega-menu mega-menu-sm">
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        <i class="icon-grid menu-icon mr-3"></i><span class="nav-text">Data Master</span>
                    </a>
                ...
                <li class="mega-menu mega-menu-sm">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('purchase_order') }}">DATA Purchase Order</a></li>
                        <li><a href="{{ route('transaksi') }}">Data Pengeluaran KAS</a></li>
    ...
    <div class="footer">
        <div class="copyright">
            <p>Aplikasi Keuangan Pengeluaran kas PT TESSO TETRA CHEMICA</a> {{ date('Y') }}</p>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $("#total_beli, #harga").keyup(function() {
            var harga  = $("#harga").val();
            var jumlah = $("#total_beli").val();
