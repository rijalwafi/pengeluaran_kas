              ...
              <div class="form-group">
                <div class="form-group has-feedback">
                  ...
                  <select class="form-control @error('level') is-invalid @enderror" name="level">
                    <option <?php if(old("level", $user->level) == "manajer"){echo "selected='selected'";} ?> value="manajer">Manajer</option>
                    <option <?php if(old("level", $user->level) == "finance"){echo "selected='selected'";} ?> value="finance">Finance</option>
                  </select>
